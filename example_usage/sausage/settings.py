"""
Django settings for sausage project.
...
SECRET_KEY = 'django-insecure-am0llus4=!b!mvb$z57z)_q8)zv$v#*z**%ozu+ihystd@xn%l'
...
WSGI_APPLICATION = 'sausage.wsgi.application'
